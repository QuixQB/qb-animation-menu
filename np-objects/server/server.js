! function() {
	...
	RPC.register('np-objects:SaveObject', async (_0x201f43, _0xb11f82, _0x33f68d, _0x4159b7, _0x215819) => {
		let _0x5eecf6 = {
				'x': _0x33f68d.x,
				'y': _0x33f68d.y,
				'z': _0x33f68d.z,
	...
	RPC.register('np-objects:DeleteObject', async (_0x51b12d) => {
		let _0x2fb105 = await SQL.execute('SELECT * FROM objects WHERE id = @id', {
			'id': _0x51b12d
		});
	...
	RPC.register('np-objects:UpdateObject', async (_0xf79e9b, _0x43c89e) => {
